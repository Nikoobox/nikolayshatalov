    ...
    render() {
        return (
            ...
            <section className="background">
                ...
                <div className='wave' style={{ width: `100%` }}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" stroke='transparent' stroke-width='0px' shape-rendering="crispEdges"><path fill="#0d1d27" fill-opacity="1" d="M0,256L80,250.7C160,245,320,235,480,208C640,181,800,139,960,112C1120,85,1280,75,1360,69.3L1440,64L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg></div> 
